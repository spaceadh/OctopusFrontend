...
const allProducts = [
  { id: 'properties', name: 'Property Management', description: 'Manage properties, tenants, and leases.', subscribed: true, redirect:'/app/properties' },
  { id: 'lending', name: 'Lending Engine', description: 'Manage loans, borrowers, and repayments.', subscribed: true, redirect:'/app/lending' },
